...
// TODO: класс не нужен здесь. достаточно Mesh. при этом Mesh без материала. материал идет отдельно. А для загрузки сделать класс который возвращает меши и материалы из ассимп
